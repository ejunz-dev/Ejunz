...
import type { AgentScheduleDoc, AgentScheduleRunDoc } from 'ejun/src/model/agent_schedule';
import type { SystemToolExecutionContext, ToolArgs } from '../types';

type AgentScheduleModelStatic = typeof import('ejun/src/model/agent_schedule').default;

export function AgentScheduleModel(): AgentScheduleModelStatic {
    return require('ejun/src/model/agent_schedule').default;
}
