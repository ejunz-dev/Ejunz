...
window.Ejunz.components.Dialog = Dialog;
window.Ejunz.components.InfoDialog = InfoDialog;
window.Ejunz.components.ActionDialog = ActionDialog;
window.Ejunz.components.ConfirmDialog = ConfirmDialog;
