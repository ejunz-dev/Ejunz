...
export function roadmapCardKindLabel(kind: RoadmapNodeKind): string {
  switch (kind) {
    case 'main': return i18n('Base roadmap card type main');
    case 'sub': return i18n('Base roadmap card type sub');
    case 'hook': return i18n('Base roadmap card type hook');
    case 'text': return i18n('Base roadmap card type text');
    default: return i18n('Base roadmap card type sub');
  }
}
