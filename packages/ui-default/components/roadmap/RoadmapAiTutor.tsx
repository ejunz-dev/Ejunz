...
import { buildRoadmapTutorSuggestedQuestions } from './ai/suggested_questions';
import { useRoadmapAiTutorChat } from './ai/useRoadmapAiTutorChat';
...
export type RoadmapAiTutorProps = {
  nodes: Node[];
  edges: Edge[];
  docTitle: string;
  branch: string;
...
export function RoadmapAiTutor({
  nodes,
  edges,
  docTitle,
  branch,
  ...
  const suggestedQuestions = useMemo(
    () => buildRoadmapTutorSuggestedQuestions(nodes, docTitle),
    [nodes, docTitle],
  );
