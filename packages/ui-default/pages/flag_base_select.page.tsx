...
function FlagBaseSelectPage() {
  ...
  const handleSubmit = async () => {
    ...
    setSaving(true);
    try {
      await request.post(`/d/${domainId}/flag/base`, { baseDocId: current });
...
const page = new NamedPage('flag_base_select', async () => {
  const container = document.getElementById('flag-base-select-container');
  if (!container) return;
  ReactDOM.render(<FlagBaseSelectPage />, container);
});
