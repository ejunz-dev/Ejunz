...
function CollectBaseSelectPage() {
  ...
  const handleSubmit = async () => {
    ...
    setSaving(true);
    try {
      await request.post(`/d/${domainId}/collect/base`, { baseDocId: current });
...
const page = new NamedPage('collect_base_select', async () => {
  const container = document.getElementById('collect-base-select-container');
  if (!container) return;
  ReactDOM.render(<CollectBaseSelectPage />, container);
});
