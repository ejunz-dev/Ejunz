import type { LangConfig } from '@ejunz/utils/lib/lang';
import { NormalizedSubtask } from '@ejunz/utils/lib/utils';
import type { JudgeRequest as OrigJudgeRequest, ObjectId } from 'ejun';
import { JudgeResultBody, ProblemConfigFile } from 'ejun';
